...
This mechanism has been integrated into Bitcore-Node-MNOS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MNOSIO/insight-api-mnos#web-socket-api](https://github.com/MNOSIO/insight-api-mnos#web-socket-api)
* API: [https://github.com/MNOSIO/insight-api-mnos#instantsend-transactions](https://github.com/MNOSIO/insight-api-mnos#instantsend-transactions)
...
By default, the MNOS Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MNOS Core daemon:
