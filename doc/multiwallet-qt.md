...
Only requiring some minor changes is mnos.cpp.
...
Changes to mnos.cpp
----------------------
mnos.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
