    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MNOS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MNOS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mnos: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MNOS Core"), this);
    aboutAction->setStatusTip(tr("Show information about MNOS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MNOS Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MNOS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MNOS addresses"));
    ...
    openAction->setStatusTip(tr("Open a mnos: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MNOS Core help message to get a list with possible MNOS Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MNOS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MNOS network", "", count));
    } else {
...
{
    QString strTitle = tr("MNOS Core"); // default title
