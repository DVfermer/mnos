    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MNOS-light"), QVariant("light"));
    ui->theme->addItem(QString("MNOS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MNOS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MNOS-traditional"), QVariant("trad"));
