    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MNOS Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MNOS Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  mnos-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MNOS in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MNOS, 0.1 MNOS, 1 MNOS and 10 MNOS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://mnos.io/PrivateSend\">https://mnos.io/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MNOS Core is shutting down...") + "<br /><br />" +
