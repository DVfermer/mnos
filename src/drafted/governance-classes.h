 ...
 *
 *   // network
 *   CMNOSNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mnos.io/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMNOSNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: MNOSNetwork
// //   -- signature requirements : Key1(User)
// class CMNOSNetworkVariable : public CGovernanceObject
// {
// private:
