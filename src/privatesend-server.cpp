...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all MNOS related functionality
...
/*
    ...
    allow endless transaction that would bloat MNOS and make it unusable. To
